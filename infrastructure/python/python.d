...
///////////////////////////////////////////////////////////////////////////////
  ...
  version(Python2_4){
      ...
      PyObject *PyRun_FileFlags(FILE *, char *, int, PyObject *, PyObject *, 
              PyCompilerFlags *);
      ...
      PyObject *PyRun_FileFlags()(FILE *fp, char *p, int s, PyObject *g, 
...
struct PycStringIO_CAPI {
  ...
  int function(PyObject *, char *, Py_ssize_t) cwrite;
